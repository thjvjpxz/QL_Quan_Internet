...
namespace Entity
{
    class ConnectSQL
    {
        private string conStr = @"Data Source=DESKTOP-BED894K;Initial Catalog=QLINTERNET;Integrated Security=True";
        ...
        {
            OpenConnect();
            string query = "SELECT IDMay, TenMay FROM May";
        ...
        {
                string query = "SELECT IDMay, TenMay FROM May WHERE IDMay like '%"+may.IDMay+"%'";
